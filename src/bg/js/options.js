...
async function populateAnkiFields(options) {
    ...
    let fields = ['expression', 'reading', 'extrainfo', 'definition', 'definitions', 'sentence', 'url', 'audio', 'imageurl'];
...
function populateSysScriptsList(dictLibrary) {
    ...
    let systemscripts = [
        'builtin_enen_Collins', 'builtin_encn_Collins', 'general_Makenotes',//default & builtin script
...
async function onSaveClicked(e) {
    ...
    let fields = ['deckname', 'typename', 'expression', 'reading', 'extrainfo', 'definition', 'definitions', 'sentence', 'url', 'audio', 'imageurl'];
    fields.forEach(field => {
